...
- [- Nameserver (NS): Allows delegation to occur in the DNS.](#--nameserver-ns-allows-delegation-to-occur-in-the-dns)
...
- [1.13. Serverless-and-App-Services](#113-serverless-and-app-services)
  ...
  - [Kinesis Data Analyticsn](#kinesis-data-analyticsn)
...
- [- Supports multiple accounts (Master, account you enabled GD in, and invited Members)](#--supports-multiple-accounts-master-account-you-enabled-gd-in-and-invited-members)
...
- [119-network-fundamentals](#119-network-fundamentals)
---
